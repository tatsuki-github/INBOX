/**
 * 1000-question (10×100) repo-grounded QA evaluation harness.
 *
 * Usage:
 *   cd backend && npx tsx scripts/eval-1000q/run.ts [--round N] [--retry-failed] [--concurrency 8]
 */
...
const DATA = join(ROOT, "data/eval-1000q");
