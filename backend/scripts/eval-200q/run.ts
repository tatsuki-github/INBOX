/**
 * 200-question (10×20) repo-grounded QA evaluation harness.
 *
 * Usage:
 *   cd backend && npx tsx scripts/eval-200q/run.ts [--round N] [--retry-failed] [--concurrency 3]
 */
...
const DATA = join(ROOT, "data/eval-200q");
