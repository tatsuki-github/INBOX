/**
 * unique-exhausted (~4639) repo-grounded QA evaluation harness.
 *
 * Usage:
 *   cd backend && npx tsx scripts/eval-unique/run.ts [--round N] [--retry-failed] [--concurrency 8]
 */
...
const DATA = join(ROOT, "data/eval-unique");
