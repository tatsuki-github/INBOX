#!/usr/bin/env python3
"""Build women_top6_2012_2025.json and women_top6_athletes.csv from reconciled OCR."""
...
def validate_year(year: str, entry: dict) -> list[str]:
    notes: list[str] = []
    teams = entry["teams"]
    assert len(teams) == TOP_TEAM_COUNT, year
    for t in teams:
        assert len(t["legs"]) == 5
        prev = 0
        for L in t["legs"]:
...
data["years"]["2025"] = {
    ...
    "teams": [
        ...
        team(
            ...
            "44:56",
            [
                leg(1, "福島志帆", 3, "11:15", "11:15"),
                leg(2, "山道咲空", 1, "6:56", "18:11"),
                leg(3, "吉本琉音", 3, "7:33", "25:44"),
                leg(4, "佐藤妃葵", 3, "7:23", "33:07"),
                leg(5, "内野花笑", 2, "11:49", "44:56"),
            ],
        ),
        team(
            6,
            ...
            "45:09",
            [
                leg(1, "松山杏海", 3, "10:33", "10:33"),
                leg(2, "宮本奈留", 3, "7:17", "17:50"),
                leg(3, "宮本奈英", 1, "7:46", "25:36"),
                leg(4, "池田結衣", 3, "7:44", "33:20"),
                leg(5, "中尾彩朱", 3, "11:49", "45:09"),
            ],
        ),
    ],
    "confidence": "verified",
...
data["years"]["2024"] = {
    ...
    "teams": [
        ...
        team(
            ...
            "43:50",
            [
                leg(1, "鹿子木歩", 2, "10:16", "10:16"),
                leg(2, "小山にこり", 3, "6:38", "16:54"),
                leg(3, "大木夏帆", 2, "8:02", "24:56"),
                leg(4, "中岡希海", 3, "7:43", "32:39"),
                leg(5, "大木莉子", 1, "11:11", "43:50"),
            ],
        ),
        team(
            6,
            ...
            "45:06",
            [
                leg(1, "角田里奈", 3, "10:43", "10:43"),
                leg(2, "瀧下那奈", 3, "6:59", "17:42"),
                leg(3, "高田麻由", 2, "7:40", "25:22"),
                leg(4, "村上咲稀", 2, "7:50", "33:12"),
                leg(5, "福島まりん", 2, "11:54", "45:06"),
            ],
        ),
    ],
    "confidence": "verified",
...
data["years"]["2023"] = {
    ...
    "teams": [
        ...
        team(
            ...
            "44:58",
            [
                leg(1, "田畑結愛", 3, "11:18", "11:18"),
                leg(2, "平山果朋", 2, "6:55", "18:13"),
                leg(3, "坂本杏奈", 1, "7:20", "25:33"),
                leg(4, "三良礼愛", 3, "7:28", "33:01"),
                leg(5, "川下結音", 3, "11:57", "44:58"),
            ],
        ),
        team(
            6,
            ...
            "45:19",
            [
                leg(1, "鹿子木歩", 3, "10:33", "10:33"),
                leg(2, "坂口穂波", 1, "6:59", "17:32"),
                leg(3, "大木夏帆", 3, "7:06", "24:38"),
                leg(4, "小山にこり", 2, "8:33", "33:11"),
                leg(5, "出村紗雪", 1, "12:08", "45:19"),
            ],
        ),
    ],
    "confidence": "verified",
...
data["years"]["2022"] = {
    ...
    "teams": [
        ...
        team(
            ...
            "44:49",
            [
                leg(1, "矢加部乃彩", 3, "11:13", "11:13"),
                leg(2, "土山紗也佳", 1, "7:13", "18:26"),
                leg(3, "土田夏七海", 3, "7:13", "25:39"),
                leg(4, "坂田涼葉", 2, "7:12", "32:51"),
                leg(5, "木下恋夢", 2, "11:58", "44:49"),
            ],
        ),
        team(
            6,
            ...
            "45:12",
            [
                leg(1, "鹿子木歩", 1, "10:55", "10:55"),
                leg(2, "坂口穂波", 1, "7:11", "18:06"),
                leg(3, "大木夏帆", 2, "6:58", "25:04"),
                leg(4, "中岡希海", 3, "8:02", "33:06"),
                leg(5, "松岡粧音", 2, "12:06", "45:12"),
            ],
        ),
    ],
    "confidence": "verified",
...
data["years"]["2021"] = {
    ...
    "teams": [
        ...
        team(
            ...
            "44:18",
            [
                leg(1, "内田千惺", 1, "11:09", "11:09"),
                leg(2, "徳永理子", 3, "6:53", "18:02"),
                leg(3, "片山美璃愛", 2, "7:17", "25:19"),
                leg(4, "亀木咲良", 3, "7:12", "32:31"),
                leg(5, "藤村光咲", 3, "11:47", "44:18"),
            ],
        ),
        team(
            6,
            ...
            "44:22",
            [
                leg(1, "西川侑里", 1, "9:57", "9:57"),
                leg(2, "濱口葵", 2, "6:57", "16:54"),
                leg(3, "藤本千尋", 2, "7:52", "24:46"),
                leg(4, "高松春花", 2, "8:21", "33:07"),
                leg(5, "横尾悠", 2, "11:15", "44:22"),
            ],
        ),
    ],
    "confidence": "verified",
...
data["years"]["2020"] = {
    ...
    "teams": [
        ...
        team(
            ...
            "45:52",
            [
                leg(1, "山下紗瑛", 3, "9:55", "9:55"),
                leg(2, "鍋島彩里", 2, "6:17", "16:12"),
                leg(3, "里未羽", 1, "7:51", "24:03"),
                leg(4, "市村千代", 1, "8:43", "32:46"),
                leg(5, "笠原栞", 2, "13:06", "45:52"),
            ],
        ),
        team(
            6,
            ...
            "45:54",
            [
                leg(1, "福島まひる", 1, "10:54", "10:54"),
                leg(2, "西本莉奈", 2, "7:15", "18:09"),
                leg(3, "高田麻由", 1, "7:29", "25:38"),
                leg(4, "田堀心愛", 3, "7:59", "33:37"),
                leg(5, "松嶋一常", 2, "12:17", "45:54"),
            ],
        ),
    ],
    "confidence": "verified",
    "ocr_notes": ["全138セルを原画像と目視照合済み"],
}
...
data["years"]["2017"] = {
    ...
    "teams": [
        ...
        team(
            ...
            "43:35",
            [
                leg(1, "山門ひかり", 3, "10:27", "10:27"),
                leg(2, "大江莉奈", 3, "7:09", "17:36"),
                leg(3, "藤本佑菜", 3, "7:12", "24:48"),
                leg(4, "前田琳香", 2, "7:48", "32:36"),
...
def main() -> None:
    ...
    json_path = OUT_DIR / "women_top6_2012_2025.json"
    json_path.write_text(json.dumps(data, ensure_ascii=False, indent=2) + "\n", encoding="utf-8")

    csv_path = OUT_DIR / "women_top6_athletes.csv"
    ...
    print("athletes", sum(TOP_TEAM_COUNT * 5 for _ in data["years"]))
