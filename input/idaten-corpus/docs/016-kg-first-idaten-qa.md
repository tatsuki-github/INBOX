...
| 回帰 | 「9/20の予定」→ なごみ / 「去年の荒玉優勝校」→ 2025 優勝校 | `backend/tests/answer.test.ts` |
...
- 相対年展開 + winners-by-year + 該当年 transcripts 優先で「去年の荒玉優勝校」を回答可能に
- スコープをリポジトリ知識コーパス全体へ拡大（ハード拒否のみ外部話題）
