...
- Notion `query_data_sources` 上限時 → view モード＋search/fetch で補完（一部 DB は partial）
...
設計: [ADR 010](../../docs/adr/010-external-idaten-import.md) / [ADR 011](../../docs/adr/011-idaten-media-ocr-kg.md)
