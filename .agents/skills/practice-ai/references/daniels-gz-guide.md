...
4. **各 GZ 行には必ず 1km 平均ペース（`k/M:SS` 形式）を含める** — CLI 出力の `k/4:10〜k/4:16` 等をそのまま転記
5. 心拍・乳酸は補足（ペースの主根拠は Daniels 計算結果）
...
VDOT 64.0
T (Threshold): 3:29/km
GZ 600m: 2:10〜2:13 k/3:37〜k/3:41（T+8〜12秒/km）
GZ 1000m: 3:41〜3:47 k/3:41〜k/3:47（T+12〜18秒/km）
```
